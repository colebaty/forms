...
for row in csv_reader:
    ...
    with tempfile.NamedTemporaryFile(suffix='.fdf', dir='/tmp') as temp_file:
        ...
        os.system(f'pdftk ../barcode_test.pdf fill_form "{fdf_file.name}" output "./output-{docNo}-nsn.pdf" flatten')

os.system(f'pdftk ./output-*.pdf cat output ./turn-in-forms-with-nsn.pdf')
